...
public:
    ...
    EntryInfo EntryFunc(const std::string &key) {
        ...
        else if (key == "s_radar") return EntryInfo(key, type_name, {2,9}); // 后续改成参数设置
        ...
        else if (key == "s_enemy") return EntryInfo(key, type_name, {20,9}); // 后续改成参数设置
        // else if (key == "id_enemy") return EntryInfo(key, type_name, {20}); // 后续改成参数设置
        else if (key == "s_enemy_mask") return EntryInfo(key, type_name, {20,20}); // 后续改成参数设置
